...
import com.mario.transformer.controllers.mappers.OrderFullEventMapper;
import com.mario.transformer.models.Event;
import com.mario.transformer.repositories.EventRepository;
import com.mario.transformer.util.TransactionalHelper;
...
public class KafkaControllerService {
    ...
    public void sendToKafkaAndDBScenario31(OrderEvent event) {
